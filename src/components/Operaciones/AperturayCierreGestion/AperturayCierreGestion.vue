<template>
	<v-card>
		<v-toolbar color="primary" style="color:white">
			<v-toolbar-title>Datos de Apertura y CierreGestion</v-toolbar-title>
			<v-divider></v-divider>
		...
		<v-data-table 	style="padding: 5px"
			...
			<template v-slot:top>
				<v-tooltip bottom>
					<template v-slot:activator="{ on }">
						<v-btn color="botonCrear" dark v-on="on" @click="Insertar()">Añadir Registro de Apertura y Cierre de Gestion</v-btn>
					</template>
		...
		<v-dialog v-model="dialog" persistent max-width="50%">
			<v-card>
				<v-toolbar style="padding:10px" dark class="primary">
					<v-toolbar-title>Datos de Apertura y Cierre de Gestion</v-toolbar-title>
				</v-toolbar>
				<v-divider></v-divider>
		...
		<v-card>
			<v-toolbar color="primary" style="color:white">
			<v-toolbar-title>Datos de Apertura y Cierre Gestion</v-toolbar-title>
			<v-divider></v-divider>
			<v-text-field v-model="buscaraperturaycierregestion"
					append-icon="search"
					label="Buscar Registro"
		...
		<v-data-table 	style="padding: 5px"
						:headers="headersEdit" 
						:items="lstaperturaformateadosEdit" 
						:items-per-page="30"
						:search = "buscaraperturaycierregestion" 
						:footer-props="{
							showFirstLastPage: true,
