<template>
	<v-card>
		<v-toolbar color="primary" style="color:white">
			<v-toolbar-title>Datos de jerarquia</v-toolbar-title>
			<v-divider></v-divider>
			<v-text-field v-model="buscarjerarquia"
					append-icon="search"
		...
		<v-data-table 	style="padding: 5px"
			...
			<template slot="item" slot-scope="props">
				<tr>
					<!--<td>{{ helper.showDataDescription(props.item.jerarquia,lstjerarquia, id, descripcion)  }}</td>// Ejemplo de Uso de Helper Para obtener la Descripcion de una Tabla por medio de su Id-->
					...
					<td>
						...
						<v-tooltip style="padding-left:10px" bottom color="#008080">
							...
							<span>Eliminar Registro de jerarquia</span>
						</v-tooltip>
					</td>
				</tr>
			</template>
...
<script src="./jerarquia.ts"></script>
