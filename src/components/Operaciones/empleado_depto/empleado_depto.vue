<template>
	<v-card>
		<v-toolbar color="primary" style="color:white">
			<v-toolbar-title>Datos de empleado depto</v-toolbar-title>
			<v-divider></v-divider>
          ...
          <!--
					...
					<td>
						<v-tooltip bottom>
							...
							<span>Modificar Registro de empleado depto</span>
						</v-tooltip>
						<v-tooltip style="padding-left:10px" bottom>
							<template v-slot:activator="{ on }" >
								<v-btn color="error" v-on="on" fab small dark  @click="Eliminar(props.item)"><v-icon>delete</v-icon></v-btn>
							</template>
							<span>Eliminar Registro de empleado depto</span>
						</v-tooltip>
					</td>
				</tr>
			</template>
			<template v-slot:top>
				<v-tooltip bottom>
					<template v-slot:activator="{ on }">
						<v-btn color="accent" v-on="on" @click="Insertar()">Adicionar Nuevo Registro de empleado depto</v-btn>
					</template>
					<span>Adicionar nuevo registro de empleado depto</span>
				</v-tooltip>
			</template>
